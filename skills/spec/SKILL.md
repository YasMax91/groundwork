...
- **If the decisions are too unsettled to write down, run `grill` before the spec** — not a spec padded
  with assumptions. A document that records guesses as scope is more expensive than one more interview.
