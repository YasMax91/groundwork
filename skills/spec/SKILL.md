...
4. **Write acceptance criteria** that are testable and map to the verification plan.
...
6. **List risks, assumptions, and the verification plan** (which tests, which gates).
