...
runs "estimate-claim"  "estimate-claim.sh"  '{"hook_event_name":"Stop","last_assistant_message":"Это займёт часов 6."}'
...
runs "defect-scan"     "defect-scan.sh"     '{"hook_event_name":"Stop"}'
