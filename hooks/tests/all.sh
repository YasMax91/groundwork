...
for suite in lib run test-gate gates openapi-gate coverage-claim estimate-ledger estimate-claim task-intent agent-contract statusline session-start failsafe; do
  f="$DIR/${suite}.sh"
